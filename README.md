...
- [`src/ddpg`](src/ddpg): the algorithm itself, including the replay buffer,
  Ornstein-Uhlenbeck exploration noise, actor/critic networks, and the
  `DDPGAgent` that ties them together.
